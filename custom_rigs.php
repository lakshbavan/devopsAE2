...
<html lang="en">
  ...
  <body>
    ...
    <div class="it_service">
      ...
      <div class="build_image"> <!-- cabinet images -->
        <img id='cabinet_image' src="images\lenovo-legion-y520-gaming-pc.jpg" alt="Please select a cabinet" style="width: 250px;">
      </div>
      ...
      <div class="build_inputs"> <!-- form inputs -->
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
          ...
          <!-- PROCESSOR -->
          <select  name="cpu" class="build_inputs" id="cpu_select" onchange="input_entered(this.name);calc_total(this.value);"> 
          ...
          <!-- GPU -->
          <select  name="gpu" class="build_inputs" id="gpu_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- RAM -->
          <select  name="ram" class="build_inputs" id="ram_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- MOTHERBOARD -->
          <select  name="mb" class="build_inputs" id="mb_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- SSD -->
          <select  name="ssd" class="build_inputs" id="ssd_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- HDD -->
          <select  name="hdd" class="build_inputs" id="hdd_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- POWER SUPPLY -->
          <select  name="power_supply" class="build_inputs" id="psu_select" onchange="input_entered(this.name);calc_total(this.value);">
          ...
          <!-- CPU COOLER -->
          <select  name="cpu_cooler" class="build_inputs" id="cpu_cooler_select" onchange="input_entered(this.name);calc_total(this.value);">
  ...
  padding: 10px;background-color: rgb(51, 1, 109);border:none;color:white;border-radius:15px;font-size:1em;cursor: pointer;">
    ...
    <script src="custom_rigs.js"></script>
